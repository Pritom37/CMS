 ...
 <div class="main-content">
    ...
    <!-- Button to Add Admin  Ends-->
            <table class="tbl-full">
                ...
                <?php 
                // query to get all teacher from tbl-user
                $sql = "SELECT * FROM tbl_user WHERE user_type='teacher'";
                //Execute the query
                ...
                <tr>
                    <td><?php  if($user_type=="teacher"){ echo $sn++;} ?></td>
                    <td><?php  if($user_type=="teacher"){echo $username; }?></td>
                    <td><?php  if($user_type=="teacher"){echo $email; }?></td>
                    <td><?php  if($user_type=="teacher"){echo $user_type; }?></td>
                    <td>
                    <a href="<?php echo SITEURL; ?>panel/Admin/update-teacher.php?id=<?php echo $id; ?>" class="btn-primary">Update Teacher</a>
