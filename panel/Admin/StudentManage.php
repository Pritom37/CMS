 ...
 <div class="main-content">
    ...
    <!-- Button to Add Admin  Ends-->
            <table class="tbl-full">
                ...
                <?php 
                // query to get all student from tbl-user
                $sql = "SELECT * FROM tbl_user WHERE user_type='student'";
                //Execute the query
                ...
                <tr>
                    <td><?php  if($user_type=="student"){ echo $sn++;} ?></td>
                    <td><?php  if($user_type=="student"){echo $username; }?></td>
                    <td><?php  if($user_type=="student"){echo $email; }?></td>
                    <td><?php  if($user_type=="student"){echo $user_type; }?></td>
                    <td>
                    <a href="<?php echo SITEURL; ?>panel/Admin/update-student.php?id=<?php echo $id; ?>" class="btn-primary">Update Student</a>
